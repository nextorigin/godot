...
(function() {
  var Client, back, clone, dgram, events, ip, net, noop, tls, utile, utils, uuid,
  ...
  Client = (function(_super) {
    ...
    Client.prototype.validate = function(options) {
      var _ref, _ref1;
      if (_ref = (options != null ? options.type : void 0) != null, __indexOf.call(this.validTypes, _ref) < 0) {
        return "Cannot create server without type: " + (this.validTypes.join(', '));
      }
      if (_ref1 = options.format != null, __indexOf.call(this.validFormats, _ref1) < 0) {
        return "Cannot create server without format: " + (this.validFormats.join(', '));
      }
      if (typeof (options.reconnect != null) !== "object") {
    ...
    Client.prototype.add = function(producer) {
      ...
      producer.on("end", this.handlers.end[id] = function() {
